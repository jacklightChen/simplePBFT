...
//		logger.Info("[REQUEST] ClientID: %s, Timestamp: %d\n", reqMsg.ClientID, reqMsg.Timestamp)
...
//		logger.Info("[PREPREPARE] ClientID: %s, SequenceID: %d\n", prePrepareMsg.RequestMsg.ClientID, prePrepareMsg.SequenceID)
//	case *consensus.VoteMsg:
//		voteMsg := msg.(*consensus.VoteMsg)
//		if voteMsg.VoteType == consensus.PrepareMsg {
//			logger.Info("[PREPARE] NodeID: %s\n", voteMsg.NodeID)
//		} else if voteMsg.VoteType == consensus.CommitMsg {
//			logger.Info("[COMMIT] NodeID: %s\n", voteMsg.NodeID)
//		}
//	}
//}
